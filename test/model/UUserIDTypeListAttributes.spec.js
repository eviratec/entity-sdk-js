...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EviratecEntityApi.UUserIDTypeListAttributes();
  });
  ...
  describe('UUserIDTypeListAttributes', function() {
    it('should create an instance of UUserIDTypeListAttributes', function() {
      // uncomment below and update the code to test UUserIDTypeListAttributes
      //var instane = new EviratecEntityApi.UUserIDTypeListAttributes();
      //expect(instance).to.be.a(EviratecEntityApi.UUserIDTypeListAttributes);
    });
